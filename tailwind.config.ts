  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "laser-left": "laser-left 1.8s ease-in-out infinite, laser-color 3s linear infinite",
        "laser-right": "laser-right 1.8s ease-in-out infinite, laser-color 3s linear infinite",
      },
    },
  },

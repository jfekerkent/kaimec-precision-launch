        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[{ label: "Home", to: "/" }, { label: "About Us", to: "/about" }, { label: "Dealers", to: "/dealers" }, { label: "FAQ", to: "/faq" }, { label: "Request for Info", to: "/quote" }].map((l) => (
                <li key={l.to}>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { label: "Tube & Profile Laser Cutting Machines", to: "/machines/tube-profile-lasers" },

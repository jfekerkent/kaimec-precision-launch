...
export const categories = [
  { name: "Fiber Machines", slug: "cnc-fiber-lasers", description: "High-speed precision fiber laser cutting systems for sheet metal fabrication." },
...
export const machines: Machine[] = [
  {
    id: "kflo-1530",
    model: "FLO-1530",
    category: "Fiber Machines",
    categorySlug: "cnc-fiber-lasers",
    description: "Open Type Fiber Machine",
  ...
  },
  {
    ...
    category: "Fiber Machines",
    categorySlug: "cnc-fiber-lasers",
    description: "Closed Type Fiber Machine",
    specs: { "Laser Power": "6,000W", "Bed Size": "3000 × 1500 mm", "Max Speed": "120 m/min", "Positioning Accuracy": "±0.03 mm" },
    image: "fiber-laser",
  },
  {

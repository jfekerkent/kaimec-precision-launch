...
const specRows: { label: string; values: string[] }[] = [
  ...
  { label: "Max Pipe Length", values: ["6000 mm (20 ft) standard / 30 ft optional", "6000 mm (20 ft) standard / 30 ft optional"] },
...
const flopSpecRows: { label: string; values: string[] }[] = [
  ...
  { label: "Max Pipe Length", values: ["6000 mm (20 ft) standard / 30 ft optional", "6000 mm (20 ft) standard / 30 ft optional", "6000 mm (20 ft) standard / 30 ft optional"] },
      ...
      <section className="py-20 bg-[#f8f8f8]">
        <div className="container max-w-6xl">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <ConfigCard
              img={flcP1530Img}
              title="FLC-P 1530 (fully enclosed/2 tables)"

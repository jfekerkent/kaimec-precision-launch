...
import comboFlcp1530NewAsset from "@/assets/combo-flcp-1530-new.jpg";
import comboFlcp2040NewAsset from "@/assets/combo-flcp-2040-new.jpg";
import comboFlcp2040New2Asset from "@/assets/combo-flcp-2040-new2.jpg";
import comboFlop1530AAsset from "@/assets/combo-flop-1530-new-a.png";
import comboFlop1530BAsset from "@/assets/combo-flop-1530-new-b.png";
import comboFlop2040AAsset from "@/assets/combo-flop-2040-new-a.png";
import comboFlop2040BAsset from "@/assets/combo-flop-2040-new-b.png";
import comboFlop2040CAsset from "@/assets/combo-flop-2040-new-c.png";
import comboFlop2040DAsset from "@/assets/combo-flop-2040-new-d.png";
const flcP1530Img = comboFlcp1530NewAsset;
const flcP2040Img = comboFlcp2040NewAsset;
const flcP2040ImgAlt = comboFlcp2040New2Asset;
const floP1530A = comboFlop1530AAsset;
const floP1530B = comboFlop1530BAsset;
const floP2040Front = comboFlop2040BAsset;
const floP2040Persp = comboFlop2040AAsset;
const floP2060Side = comboFlop2040CAsset;
const floP2060Persp = comboFlop2040DAsset;
...
const configurations = ["FLC-P 1530 (fully enclosed with 2 tables)", "FLC-P 2040 (fully enclosed with 2 tables)"];
...
const specRows: { label: string; values: string[] }[] = [
  ...
  { label: "Max Pipe Length", values: ["6000 mm (20 ft) standard / 30ft optional", "6000 mm (20 ft) standard / 30ft optional"] },
...
const flopSpecRows: { label: string; values: string[] }[] = [
  ...
  { label: "Max Pipe Length", values: ["6000 mm (20 ft) standard / 30ft optional", "6000 mm (20 ft) standard / 30ft optional", "6000 mm (20 ft) standard / 30ft optional"] },
      ...
      <section className="py-20 bg-[#f8f8f8]">
        <div className="container max-w-6xl">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <ConfigCard
              img={flcP1530Img}
              title="FLC-P 1530 (fully enclosed with 2 tables)"
          ...
          <div className="grid gap-8 md:grid-cols-3 mt-8">
            <RolloverConfigCard
              img={floP1530A}
              hoverImg={floP1530B}
               title="FLO-P 1530 ( open, single table)"

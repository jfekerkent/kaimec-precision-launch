...
const featuredMachines = [
  ...
  { tag: "Combo Lasers", name: "FLO-P 1530 ( open, single table) / FLC-P 2040 (fully enclosed/2 tables)", image: null, images: [kfloSecondaryImg, flcP1530Img], link: "/machines/covered-pipe-profile-fiber-laser" },

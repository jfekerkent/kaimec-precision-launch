      ...
      <section className="py-20 md:py-28">
        <div className="container">
          <div className="text-center mb-14">
            ...
            <p className="mt-3 text-sm text-muted-foreground font-bold border-4 rounded-lg shadow-lg font-sans md:text-3xl text-center">Available with Table sizes 5x10ft&nbsp;and 6.5x13ft&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;and 3, 6, 12, 20 kW lasers&nbsp;&nbsp;</p>
          </div>

...
const machines = [
  ...
  { id: "kflo-p-1530", model: "FLO-P 2060", description: "Open Type Laser Machine", images: [kfloTertiaryImg, kfloSecondaryImg, "placeholder:4"] },
        ...
        <div className="container max-w-5xl">
          ...
          <div className="space-y-8">
            <div className="rounded-lg border border-border bg-card p-8">
              <h3 className="text-xl font-bold text-primary mb-3">Open Type — FLO-1530 & FLO-P 2060</h3>
      ...
      <section className="py-20">
        <div className="container">
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-primary/10">
                  ...
                  <TableHead className="font-bold text-foreground text-center">FLO-P 2060</TableHead>
          ...
          <div className="md:hidden space-y-6">
            {["FLO-1530", "FLO-P 2060", "FLC-1530", "FLC-P 1530"].map((model, idx) => (

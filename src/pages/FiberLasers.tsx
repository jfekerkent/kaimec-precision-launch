...
const machines = [
  ...
  { id: "kflo-p-1530", model: "FLO-P 2060 ( open, single table)\n", description: "Open Type Laser Machine", images: [kfloTertiaryImg, kfloSecondaryImg, "placeholder:4"] },
  ...
  { id: "kflc-p-1530", model: "FLC-P 2040 (fully enclosed / 2 tables)", description: "Covered Type Pipe & Profile Fiber Laser", images: [flcP1530Img, flcP1530Img2, flcP1530Img3, flcP2040Img2] },
];
        ...
        <div className="container max-w-5xl">
          ...
          <div className="space-y-8">
            <div className="rounded-lg border border-border bg-card p-8">
              <h3 className="text-xl font-bold text-primary mb-3">Open Type — FLO-1530 & FLO-P 2060 ( open, single table)\n</h3>
            ...
            <div className="rounded-lg border border-border bg-card p-8">
              <h3 className="text-xl font-bold text-primary mb-3">Covered Type Pipe & Profile — FLC-P 2040 (fully enclosed / 2 tables)</h3>
              <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="py-20">
        <div className="container">
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-primary/10">
                  ...
                  <TableHead className="font-bold text-foreground text-center">FLO-P 2060 ( open, single table)\n</TableHead>
                  <TableHead className="font-bold text-foreground text-center">FLC-1530</TableHead>
                  <TableHead className="font-bold text-foreground text-center">FLC-P 2040 (fully enclosed / 2 tables)</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {specRows.map((row, i) => (
          ...
          <div className="md:hidden space-y-6">
            {["FLO-1530", "FLO-P 2060 ( open, single table)\n", "FLC-1530", "FLC-P 2040 (fully enclosed / 2 tables)"].map((model, idx) => (
